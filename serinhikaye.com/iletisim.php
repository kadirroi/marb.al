...
<html lang="en">
<head>
	<title> İletişim - SerinHikaye.com </title>
...
echo "<br/>";
echo "İletişim :"."<a href=\"mailto:info@serinhikaye.com\"> info@serinhikaye.com </a>";
echo "<br/><br/>";
echo "<a href=\"http://www.serinhikaye.com\" id=\"anasayfaya_don_buttonu\" class=\"btn btn-primary\">";
echo "Anasayfaya git";
echo "</a>";
echo "<br/>";
echo "</div>";
