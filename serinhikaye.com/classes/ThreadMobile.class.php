<?php
include_once ("classes/StepMobile.class.php");
...
public function ThreadToHTML()
{
	...
	echo " </style>";
	echo "<div id=\"wrapper_thread\" style=\"padding:2%;background-color:#e6e6e6;border:1px solid #c7d0d5;width: 100%; max-width:100%;\">";
		echo "<div id=\"hastag\" style=\"margin-top:1%;\">";
			echo "<a style=\" font-family: 'Josefin Sans', sans-serif; font-size:18px;margin-top:1%; \" href=".$catLink.">";
				echo "#".$threadInfos['Thread Category'];
			echo "</a>";
		echo "</div>";	
		echo "<div id=\"div_img\" style=\" margin-top:1%;\">";
			echo "<img src=\"".$threadInfos['Thread Picture']."\" style=\"max-width:100%;\"/>";
		echo "</div>";	
		echo "<div id=\"thread_adi_ve_yazar_adi_div\" style=\"margin-top:1%\">";
			echo "<p style=\"color:#cb7c7a;font-size:18px;font-family: 'Josefin Sans', sans-serif;\">";
				echo $threadInfos['Thread Name']."<br/> [".$threadInfos['Step Count']." adım]";
			echo "</p>";
			echo "<p style=\"color:#6e6e6e;font-size:15px;font-family: 'Josefin Sans', sans-serif;\" >";
				echo "Bir "."<a href=\"user.php?name=".$threadInfos['Thread Writer']."\">".$threadInfos['Thread Writer']."</a>"." eseri."." (".$threadInfos['Thread Date'].")";
			echo "</p>";
		echo "</div>";
		echo "<div id=\"sosyal buttonlar ve puan\" style=\"margin-bottom:2%;fmargin-top:1%;\">";
...
echo "<div id=\"random_for_mobile\" style=\"font-family:'Amatic SC', cursive;margin-top:2%;\">";
