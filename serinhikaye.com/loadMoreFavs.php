...
$offset = $_POST["loadMoreFavsOffset"];
...
else
{
	...
	$querios = "SELECT * FROM favoriler NATURAL JOIN threads WHERE userName='$userName' ORDER BY `threadPoint` DESC LIMIT 6 OFFSET ".$offset;
