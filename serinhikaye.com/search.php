...
echo "<input id=\"title_input_search\" style=\"display:none;\" value=\"".$searchQuery."\" />";

$mySearch = new Search($searchQuery);
$myUpmenu = new Upmenu();
...
<script type="text/javascript">
	$(document).ready(function(){
		$(this).attr("title",$('#title_input_search').val()+' - serinhikaye.com');
	});
