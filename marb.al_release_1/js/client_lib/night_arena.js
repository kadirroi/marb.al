...
night_arena.prototype.initScene = function(trees){
	...
	scene.add(this.right_roof_object);
		...
		loader.load( 'https://googledrive.com/host/0B2TF8tYSrr7aeG93bFg0dE9abjg', function ( geometry ) {
			var grave_geometry = geometry;
			for (var i=0;i<1000;i+=200){
				for (var i2=300;i2<900;i2+=200){
					var graveMesh = new THREE.Mesh( grave_geometry, new THREE.MeshPhongMaterial({color : 0xdddddd}) );
					...
					var graveMesh2 = new THREE.Mesh( grave_geometry, new THREE.MeshPhongMaterial({color : 0xdddddd}) );
		...
		loader2.load( 'https://googledrive.com/host/0B2TF8tYSrr7aUktBNlF2QkNhdVk', function ( geometry ) {
			var tree_geometry = geometry;
			for (var i=0; i<trees.trees.length; i++){
				var rand_rot = Math.floor(Math.random() * (100)) +1;
				var rand_push = Math.floor(Math.random() * (20)) ;
				var treeMesh = new THREE.Mesh(tree_geometry, new THREE.MeshPhongMaterial({color : 0x6f4242}));
				treeMesh.rotation.y = rot;
				treeMesh.position.set(trees.trees[i].x,trees.trees[i].y,trees.trees[i].z);
				...
				treeMesh.phy_body.position.set(trees.trees[i].x,trees.trees[i].y,trees.trees[i].z);
				phy_world.addBody(treeMesh.phy_body);
			}
		});

		var loader3 = new THREE.JSONLoader();
		loader3.load( 'https://googledrive.com/host/0B2TF8tYSrr7abnQzSDVmXzYxa3M', function ( geometry ) {
			var casuta_geometry = geometry;
			var casutaMesh_left = new THREE.Mesh(casuta_geometry, new THREE.MeshPhongMaterial({color : 0xdddddd}));
			...
			var casutaMesh_right = new THREE.Mesh(casuta_geometry, new THREE.MeshPhongMaterial({color : 0xdddddd}));
	...
	texture_loader.load('https://googledrive.com/host/0B2TF8tYSrr7aSzFXNEl0eERncDA', 
	function(texture){
		var side_wall_material = new THREE.MeshPhongMaterial({map:texture});
	...
	texture_loader2.crossOrigin = '';
	texture_loader2.load('https://googledrive.com/host/0B2TF8tYSrr7aU2NQV0wxdEhMRm8', 
	function(texture){
		var wall_material = new THREE.MeshPhongMaterial({map:texture});
		this.wall1_geometry = new THREE.PlaneGeometry(200,100,32);
		this.wall1_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall1_object.position.set(900,50,1000);
		this.wall1_object.material.side = THREE.DoubleSide;
		scene.add(this.wall1_object);
		this.wall1_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall2_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall2_object.position.set(700,50,1000);
		this.wall2_object.material.side = THREE.DoubleSide;
		scene.add(this.wall2_object);
		this.wall2_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall3_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall3_object.position.set(500,50,1000);
		this.wall3_object.material.side = THREE.DoubleSide;
		scene.add(this.wall3_object);
		this.wall3_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall4_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall4_object.position.set(300,50,1000);
		this.wall4_object.material.side = THREE.DoubleSide;
		scene.add(this.wall4_object);
		this.wall4_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall8_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall8_object.position.set(-500,50,1000);
		this.wall8_object.material.side = THREE.DoubleSide;
		scene.add(this.wall8_object);
		this.wall8_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall9_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall9_object.position.set(-700,50,1000);
		this.wall9_object.material.side = THREE.DoubleSide;
		scene.add(this.wall9_object);
		this.wall9_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		...
		this.wall10_object = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall10_object.position.set(-900,50,1000);
		scene.add(this.wall10_object);
		this.wall10_object_2 = new THREE.Mesh(this.wall1_geometry, wall_material);
		this.wall10_object_2.position.set(-900,50,-1000);
		scene.add(this.wall10_object_2);

	},function(xhr){},function(xhr){});

	var texture_loader3 = new THREE.TextureLoader();
	texture_loader3.crossOrigin = '';
	texture_loader3.load('https://googledrive.com/host/0B2TF8tYSrr7ackpuOXhyQ1pOaTg', 
	function(texture){
		var credits_material = new THREE.MeshPhongMaterial({map:texture});
		var credits_object = new THREE.Mesh(new THREE.PlaneGeometry(200,200,32), credits_material);
	...
	var loaderw = new THREE.OBJMTLLoader();
	loaderw.load('./js/map/WoodenCabinObj.obj','./js/map/WoodenCabinObj.mtl',
	function ( object ) {
		var wood_cabinet_object = object;
		wood_cabinet_object.scale.set(8,5,8);
		wood_cabinet_object.position.set(0,-26.5,-1000);
		scene.add(wood_cabinet_object);
	},function(xhr){},function(xhr){});					
			...
			var loaders = new THREE.OBJMTLLoader();
			loaders.load('./js/map/klupa117.obj','./js/map/klupa117.mtl',
			function(object){
				var seat_object = object;
				var seat1 = seat_object.clone();
				seat1.rotateY(Math.PI/2);
				seat1.scale.set(1,1,3);
				seat1.position.set(-510,0,-850);
				scene.add(seat1);
				var seat2 = seat_object.clone();
		...
		var texture_loaderc = new THREE.TextureLoader();
		texture_loaderc.crossOrigin = '';
		texture_loaderc.load('https://googledrive.com/host/0B2TF8tYSrr7aT3FPZkdNN1g4QmM', 
		function(texture){
			var crate_material = new THREE.MeshPhongMaterial({map:texture});
